...
import flagIndo from "../../src/assets/flag-indonesia.png";
export const Header = () => {
  // Hamburger
                ...
                >
                  <ul className=" lg:flex gap-x-4 justify-center">
                    <li className="group">
                      <Link
                        to="/"
                        className="md:text-xs  text-dark py-2  mx-8 lg:mx-0 flex group-hover:text-green-500 hover:font-bold"
                      >
                        Beranda
                      </Link>
                    </li>
                    ...
                    <li className="group">
                      ...
                      >
                        <img src={flagIndo} alt="flag indonesia" />
                      </a>
                    </li>
                    <li className="group">
                      <a
                        href="#"
                        className="md:text-xs  lg:hidden text-dark py-2 mx-8 lg:mx-0  hover:bg-rose-400 hover:text-sm hover:text-white hover:font-bold hover:px-6 hover:py-2 hover:mb-2 rounded-full "
                      >
                        Login
                      </a>
                    </li>
                    ...
                    <li className="group">
                      <a
                        href="#"
                        className="text-xs mt-2 lg:hidden bg-green-500 rounded-full text-center text-white py-2 mx-8 lg:mx-0 flex items-center justify-center group-hover:text-white group-hover:bg-violet-500 group-hover:font-bold"
                      >
                        Submit CV
                      </a>
                    </li>
