    ...
    <>
      ...
      >
        <div className="container mx-auto max-w-7xl flex justify-center">
          <div className="flex justify-between items-center p-6 gap-x-16">
            <div className="flex">
            ...
            <div className="flex items-center  justify-center gap-x-4 ">
              ...
              <div className="group lg:block hidden">
                <a
                  href="#"
                  className="text-base md:text-[10px]  bg-green-500 rounded-full text-center text-white py-2 px-8 mx-2 flex items-center justify-center group-hover:text-white group-hover:bg-violet-500"
                >
                  <span>Submit CV</span>
                </a>
              </div>
              ...
              <div className="flex items-center">
                ...
                >
                  <ul className="block lg:flex gap-x-4 justify-center">
                    <li className="group">
                      <a
                        href="#Home"
                    ...
                    <li className="group">
                      <a
                        href="#"
                        className="md:text-xs  lg:hidden text-dark py-2 mx-8 lg:mx-0   flex group-hover:text-green-500"
                      >
                        Login
                      </a>
                    </li>
      ...
      <div
        className="bg-cover bg-center h-screen bg-no-repeat mt-10 lg:mt-16"
        style={{
          backgroundImage: `url(${backgroundImage})`,
          backgroundSize: "contain-norepeat",
        }}
      ></div>
